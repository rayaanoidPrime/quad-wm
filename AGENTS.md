...
At minimum, run the CPU-only smoke test and the relevant unit tests. GPU or simulator tests must be marked separately because CI does not have MI300X/Isaac Lab access.
